import { FaTelegramPlane, FaWhatsapp, FaTwitter, FaVk } from 'react-icons/fa'
		...
		<footer className="bg-gray-100 py-8 text-gray-700">
			<div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-center md:text-left">
				...
				<div>
					...
					<p className="text-sm">&copy; 2025 Давай сделаем. Все права защищены.</p>
				</div>

				{/* Центр — Контакты */}
				<div className="space-y-1">
					<p className="text-base text-black font-medium">+375 (25) 990-58-88</p>
				...
				<div className="flex flex-col items-center md:items-end gap-2">
					<div className="flex gap-4">
						<a href="#" className="bg-white p-2 rounded-full shadow text-indigo-600 hover:scale-105 transition">
