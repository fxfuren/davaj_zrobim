...
export default function Block2() {
  ...
  return (
    <Card className="max-w-3xl mx-auto text-center border-none">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Наши Услуги</CardTitle>
      ...
      <CardContent>
        <ul className="divide-y divide-gray-200">
          {services.map((service, index) => (
            <li
              key={index}
              className="flex justify-between items-center py-3 text-left text-sm sm:text-base"
            >
